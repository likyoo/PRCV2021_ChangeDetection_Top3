...
class CondFPN(SegmentationModel):
    """CondFPN_ is a fully convolution neural network for image semantic segmentation.
    ...
    Returns:
        ``torch.nn.Module``: **CondFPN**

    .. _CondFPN:
        CondNet: Conditional Classifier for Scene Segmentation
        https://arxiv.org/pdf/2109.10322.pdf
    ...
    def __init__(
        ...
        # SegmentationCondHead
        self.segmentation_head = SegmentationCondHead(
            in_channels=self.decoder.out_channels,
            out_channels=classes,
            activation=activation,
            upsampling=upsampling,
        ...
        self.name = "condfpn-{}".format(encoder_name)
        self.initialize()
