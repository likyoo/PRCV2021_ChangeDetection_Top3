...
from .decoder import FaPNDecoder


class FaPN(SegmentationModel):
    """FaPN_ is a fully convolution neural network for image semantic segmentation.
    ...
    def __init__(
        ...
        self.name = "fapn-{}".format(encoder_name)
        self.initialize()
